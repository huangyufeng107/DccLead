...
const hitRecords = {
  1: [
    {
      headquarterLeadId: 'HQ202605280001', leadCode: 'PYXS202605280001', taskCode: 'PYRW202605280031', aiCode: 'AIHF202605280188', callId: 'CALL-20260528-0001284', phone: '138****6721', tag: '语音信箱、拒绝打扰、厌烦、无购车意向', audio: '试听', text: '客户表示近期不希望继续接收外呼，明确要求停止联系。', reviewStatus: '待审核', systemStatus: '待处理', exceptionReason: '—',
      transcript: {
    ...
    {
      headquarterLeadId: 'HQ202605270093', leadCode: 'PYXS202605270093', taskCode: 'PYRW202605270210', aiCode: 'AIHF202605270512', callId: 'CALL-20260527-0000981', phone: '186****4309', tag: '拒接', audio: '试听', text: '连续多次未接通，系统识别为高频拒接号码。', reviewStatus: '待审核', systemStatus: '待处理', exceptionReason: '—',
      transcript: {
    ...
    {
      headquarterLeadId: 'HQ202605260045', leadCode: 'PYXS202605260045', taskCode: 'PYRW202605260118', aiCode: 'AIHF202605260301', callId: 'CALL-20260526-0000756', phone: '159****2840', tag: '投诉', audio: '试听', text: '客户反馈已投诉外呼频次过高，需加入黑名单。', reviewStatus: '已驳回', systemStatus: '已处理', exceptionReason: '—',
      transcript: {
  ...
  2: [
    {
      headquarterLeadId: 'HQ202605280017', leadCode: 'PYXS202605280017', taskCode: 'PYRW202605280047', aiCode: 'AIHF202605280205', callId: 'CALL-20260528-0000327', phone: '137****9096', tag: 'A类客户 / 投诉', audio: '试听', text: '客户为A类线索，但本次通话明确表达投诉诉求，暂停30天外呼。', reviewStatus: '待审核', systemStatus: '已处理', exceptionReason: '冲突任务',
      transcript: {
    ...
    {
      headquarterLeadId: 'HQ202605250066', leadCode: 'PYXS202605250066', taskCode: 'PYRW202605250142', aiCode: 'AIHF202605250377', callId: 'CALL-20260525-0000209', phone: '152****7811', tag: '投诉', audio: '试听', text: '客户要求减少联系，坐席标记投诉标签。', reviewStatus: '待审核', systemStatus: '已处理', exceptionReason: '冲突任务',
      transcript: {
  ...
  3: [
    {
      headquarterLeadId: 'HQ202605240021', leadCode: 'PYXS202605240021', taskCode: 'PYRW202605240088', aiCode: 'AIHF202605240144', callId: 'CALL-20260524-0000089', phone: '185****3362', tag: '沉默客户 / 拒接', audio: '试听', text: '客户无有效回应，机器人回访多轮未触达。', reviewStatus: '待审核', systemStatus: '已处理', exceptionReason: '冲突任务',
      transcript: {
  ...
  4: [
    {
      headquarterLeadId: 'HQ202605220014', leadCode: 'PYXS202605220014', taskCode: 'PYRW202605220063', aiCode: 'AIHF202605220102', callId: 'CALL-20260522-0000056', phone: '139****5188', tag: '投诉', audio: '试听', text: 'IVR回访后客户反馈投诉号码，系统永久拦截。', reviewStatus: '待审核', systemStatus: '已处理', exceptionReason: '冲突任务',
      transcript: {
...
const nurtureLeadColumns = [
  ...
  { key: 'customerName', label: '客户信息', defaultVisible: true },
...
const carSeriesOptions = ['N6', 'N7', 'NX8', '轩逸', '逍客', '奇骏', '天籁'];
...
const dealerOptions = [
  ...
  { code: 'DLR-BJ-CY-002', name: '北京东风日产朝阳店', province: '北京市', city: '北京市', district: '朝阳区' },
...
const resourceUnfilledLeads = [
  ...
  { unfilledId: 'LZWM202605270093', syncStatus: '待同步', dispatchState: '滚存待推送', customerName: '陈女士', phone: '186****4309', intentSeries: '轩逸', dealer: '深圳东风日产南山店', leadType: '私域线索挖掘', leadSource: '私域运营', systemSource: '私域运营', smartCode: 'SC-SY-0234', nurtureLeadCode: 'PYXS202605270093', crowdPackageTag: '轩逸私域唤醒', timeSlotLabel: '20260527 07:00~07:29', timeSlotCapacity: 80, timeSlotRemaining: 0, createdAt: '2026-05-27' },
  ...
  { unfilledId: 'LZWM202605250118', syncStatus: '冲突重复', dispatchState: '去重过滤', customerName: '李女士', phone: '137****9088', intentSeries: '奇骏', dealer: '上海东风日产浦东店', leadType: '私域线索挖掘', leadSource: '小程序', systemSource: '小程序', smartCode: 'SC-QJ-5520', nurtureLeadCode: 'PYXS202605250118', crowdPackageTag: '奇骏试驾召回', timeSlotLabel: '20260525 08:00~08:29', timeSlotCapacity: 60, timeSlotRemaining: 0, createdAt: '2026-05-25' },
