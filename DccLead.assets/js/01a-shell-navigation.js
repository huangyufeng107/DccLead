...
function showReportsPage(defaultName = '人工坐席工单') {
  ...
  setPageName(`统计报表 / ${defaultName}`);
  if (defaultName === '人工坐席工单') {
    document.getElementById('manualAgentWorkordersPage')?.classList.add('show');
    if (typeof renderManualAgentWorkordersPage === 'function') renderManualAgentWorkordersPage();
  } else if (defaultName === '坐席业绩看板') {
    document.getElementById('seatPerformanceDashboardPage')?.classList.add('show');
    if (typeof renderSeatPerformanceDashboard === 'function') renderSeatPerformanceDashboard();
  } else {
