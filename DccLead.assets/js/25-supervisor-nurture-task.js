    ...
    return `
      <div class="sd-pagination">
        ...
        <div class="sd-pagination-btns">
          <button class="sd-page-btn ${isPrevDisabled ? 'is-disabled disabled' : ''}" onclick="window.__nurtureGoPage(${currentPage - 1})" ${isPrevDisabled ? 'disabled' : ''} aria-label="上一页">
          ...
          <button class="sd-page-btn ${isNextDisabled ? 'is-disabled disabled' : ''}" onclick="window.__nurtureGoPage(${currentPage + 1})" ${isNextDisabled ? 'disabled' : ''} aria-label="下一页">
