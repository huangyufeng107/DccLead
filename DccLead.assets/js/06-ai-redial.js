...
function openAiRedialRuleModal(mode, id) {
  ...
  document.getElementById('aiRedialRuleModalFooter').innerHTML = mode === 'view'
    ...
    : `<button class="btn-secondary" type="button" onclick="closeModal('aiRedialRuleModal')">取消</button><button class="btn-add" type="button" onclick="saveAiRedialRule('${mode}')">保存</button>`;
