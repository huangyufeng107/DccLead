...
function getPreDialerBatchMetricColumns(group = 'all') {
  ...
  const callColumns = [
    ...
    { label: '下次回访粘性路由命中率', value: metrics => metrics.stickyRoutingHitRate || '92.4%' },
    { label: '下次回访超时降级率', value: metrics => metrics.degradeRoutingRate || '7.6%' }
  ];
