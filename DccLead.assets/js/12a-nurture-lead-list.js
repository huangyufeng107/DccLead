...
function renderLeadDetailPageContent(lead) {
  ...
  const frequentBanner = isFrequent ? `
    <div style="background:#fef2f2; border:1px solid #fecaca; padding:12px 16px; border-radius:8px; margin:16px 0 16px 0; display:flex; align-items:center; gap:12px; box-shadow:0 2px 8px rgba(239,68,68,0.06);">
      ...
      <div style="flex:1;">
        <h4 style="font-size:13px; font-weight:800; color:#991b1b; margin:0 0 4px 0; display:flex; align-items:center; gap:8px;">
          <span>关键行为强提醒</span>
        ...
        <p style="font-size:12px; color:#7f1d1d; margin:0; font-weight:500;">客户${lead.customerName || lead.customer || '陆先生'}近期频繁关注车型信息，意向较高建议主动联系。</p>
      </div>
    </div>
  ` : '';
