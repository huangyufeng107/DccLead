...
const strategyConfiguratorDefs = {
  ...
  manualUnconnected: {
    ...
    form: [
      ...
      { label: '接触状态', field: 'contactStatus', type: 'select', options: 'contactStatus', required: true, section: '命中条件', placeholderOption: '请选择', conditionMode: 'contactStatus' },
      ...
      { label: '最后接触状态', field: 'lastContactStatus', type: 'select', options: 'lastContactStatus', required: true, section: '命中条件', placeholderOption: '请选择', conditionMode: 'precallTask' },
    ...
    const sections = [
      ...
      },
      {
        ...
        fields: [
          ...
          row.conditionMode === 'precallTask' ? ['最后接触状态', row.lastContactStatus] : ['接触状态', row.contactStatus],
...
function getManualUnconnectedMatchSummary(payload) {
  ...
  if (payload.conditionMode === 'contactStatus') {
    parts.push(payload.contactStatus || '—');
    ...
    parts.push(payload.lastContactStatus || '—');
    if (payload.carSeries?.length) parts.push(payload.carSeries.join('、'));
