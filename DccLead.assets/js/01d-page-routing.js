...
function showExcellentConfigManagePage(defaultTab = 'excellent-sc-config') {
  ...
  document.querySelector('.strategy-nav-item[data-page="excellent-config-manage"]')?.classList.add('active');
  ...
  switchExcellentConfigManageTab(defaultTab);
}
