...
function openDictionaryItemModal(code = '') {
  ...
  const nevDealerFields = isNevDealerDictionary
    ? `<div class="form-group"><div class="form-label">关联省份</div><input class="form-input" id="nevDealerProvince" value="${dictionaryEscape(item?.province || '')}" placeholder="选择门店后自动回填" readonly style="background:#f5f7fa;cursor:not-allowed;"></div>
       <div class="form-group"><div class="form-label">关联城市</div><input class="form-input" id="nevDealerCity" value="${dictionaryEscape(item?.city || '')}" placeholder="选择门店后自动回填" readonly style="background:#f5f7fa;cursor:not-allowed;"></div>
       <div class="form-group"><div class="form-label">关联区域</div><input class="form-input" id="nevDealerRegion" value="${dictionaryEscape(item?.region || '')}" placeholder="选择门店后自动回填" readonly style="background:#f5f7fa;cursor:not-allowed;"></div>
