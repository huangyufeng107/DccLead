...
const DICTIONARY_TYPES = [
  ...
  { code: 'INTENT_LEVEL', name: '意向等级', scope: '业务字典', description: '通话状态配置的“意向等级”下拉项共用', count: 7, importable: false },
...
const DICTIONARY_ITEMS = {
  ...
  INTENT_LEVEL: [
    { code: 'HIGH', name: '高', order: 10, status: '启用', refs: 12, description: '高意向线索' },
    { code: 'MID', name: '中', order: 20, status: '启用', refs: 10, description: '中意向线索' },
    { code: 'LOW', name: '低', order: 30, status: '启用', refs: 8, description: '低意向线索' },
    { code: 'NO_INTENT', name: '无意向', order: 40, status: '启用', refs: 6, description: '无购车意向线索' },
    { code: 'INVALID_NUM', name: '无效号码', order: 50, status: '启用', refs: 5, description: '空号/停机/错号等无效线索' }
  ],
  INITIAL_LEAD_STATUS: [
