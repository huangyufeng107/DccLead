...
const nurtureTaskItems = [
  ...
  {
    id: 'NT-202607290005', queue: 'new', customer: '周先生', phone: '137****6880', series: '天籁', level: 'C', due: '今日 16:00', channel: 'AI智能外呼', status: '新任务', source: '总部冷线索', store: '杭州东风日产西湖店', city: '杭州', project: '夏季试驾招募', last: '—', note: '首次跟进，需确认购车计划。',
    aiInsight: {
      ...
      <main class="nurture-task-detail-panel">
        ...
        <section class="nurture-task-section">
          ...
          <div class="ai-insight-panel">
            ...
            <button class="nurture-rating-result-link" type="button" data-nurture-task-action="open-rating-result">查看评级结果与客户特征</button>
          </div>
        </section>
  ...
  if (activeNurtureTaskSideTab === 'insight') {
    ...
    return `
      <div class="nurture-rating-panel">
        <div class="rating-result-label">评级结果</div>
